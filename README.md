...
* Avatar: A standard icon or personalized image chosen by the user, which also shows their name, as long as they are logged in, in different areas of the application.
